...
# load functions
source("R/epi_econ_lib_new_AltAct.R")
...
parameters <- list(
  ...
  a_rule="rt_threshold" # or "farboodi_lf", "auld_lf", "philipson", "gans", "acemoglu", "rt_threshold", "fenichel_lf"
  

)
parameters$Delta <- parameters$kappa
