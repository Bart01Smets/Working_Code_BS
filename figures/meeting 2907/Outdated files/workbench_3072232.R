...
# load functions
source("R/Epi_econ_lib_3072233.R")
...
# Parameters
parameters <- list(
  gamma = 1/7,#1/7,             # Recovery rate (γ) 1/7
...
compare_sim_output(output_experiments, output_sim_deterministic, plot_tag='binomial',
                   fadeout_threshold = fadeout_threshold)#fadeout_threshold=fadeout_threshold
# 
# 
# # RUN MODEL CHECK   ####
# ####################################################
